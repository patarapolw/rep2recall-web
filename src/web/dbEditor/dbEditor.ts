...
export class DbEditor {
    ...
    constructor(settings: IDbEditorSettings) {
        ...
        this.$el.main.removeClass("container");
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse db-editor-nav">
                    ...
                    <div class="navbar-nav">
                        <div class="nav-item mr-2 my-2 search-bar-area" id="SearchBarArea"></div>
                    </div>
                </div>
            </nav>`);
        }
        ...
        <li class="nav-item db-editor-new-entry-button-nav mr-2">
            <button class="btn btn-primary db-editor-new-entry-button form-control" type="button">
                Add new entry
            </button>
        </li>`);

        $(".search-bar-area").append(`
        <input class="form-control mr-sm-2 db-editor-search-bar wide"
